...
-- Insert sample products with ZAR pricing
INSERT INTO products (name, description, short_description, price, currency, category, service_type, delivery_days, features, requirements) VALUES
('Basic Website', 'Professional single-page website with responsive design and contact form. Perfect for small businesses and personal brands.', 'Get your business online with a stunning single-page website', 2499.00, 'ZAR', 'website', 'basic', 7, '["Responsive Design", "Contact Form", "SEO Optimization", "1 Page", "Basic Hosting", "Mobile Friendly"]', '["Business name", "Logo", "Content ideas", "Color preferences"]'),
('E-Commerce Store', 'Full online store with product management, shopping cart, and secure payment integration. Start selling online today!', 'Start selling online with a complete e-commerce solution', 5999.00, 'ZAR', 'ecommerce', 'standard', 14, '["Product Management", "Shopping Cart", "Payment Gateway", "Order Tracking", "Inventory Management", "Admin Dashboard"]', '["Product list", "Business details", "Payment preferences", "Shipping info"]'),
('Content Creation Package', 'AI-powered content creation for your website, social media, and marketing materials. Engaging content tailored to your brand voice.', 'Engaging content tailored to your brand voice', 1299.00, 'ZAR', 'content', 'basic', 3, '["Website Copy", "Social Media Posts", "Blog Articles", "SEO Optimization", "Brand Voice Matching", "Content Strategy"]', '["Business type", "Target audience", "Brand guidelines", "Content goals"]'),
('Social Media Marketing', 'Complete social media management and advertising campaigns across all platforms. Grow your audience and engagement.', 'Grow your audience and engagement across all platforms', 2999.00, 'ZAR', 'marketing', 'premium', 7, '["Content Strategy", "Post Scheduling", "Audience Analysis", "Performance Tracking", "Ad Management", "Analytics Reports"]', '["Social media accounts", "Marketing goals", "Target audience", "Budget"]'),
('Website + Marketing Bundle', 'Complete website development with integrated marketing campaign. All-in-one solution for online presence and growth.', 'All-in-one solution for online presence and growth', 7999.00, 'ZAR', 'bundle', 'premium', 14, '["Professional Website", "SEO Setup", "Social Media Integration", "Email Marketing", "Analytics Dashboard", "Content Creation"]', '["Business overview", "Target market", "Competitors", "Goals and objectives"]'),
('Custom AI Solution', 'Fully customized AI-powered solution tailored to your specific business needs. Get exactly what you need.', 'Custom AI solution for your unique requirements', 12999.00, 'ZAR', 'custom', 'enterprise', 21, '["Custom Development", "AI Integration", "API Development", "Advanced Features", "Dedicated Support", "Training"]', '["Detailed requirements", "Business processes", "Integration needs", "Timeline"]');
